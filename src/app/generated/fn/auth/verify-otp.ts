...
export function verifyOtp(http: HttpClient, rootUrl: string, params: VerifyOtp$Params, context?: HttpContext): Observable<StrictHttpResponse<AuthResponse>> {
...
verifyOtp.PATH = '/api/v1/auth/otp/verify';
